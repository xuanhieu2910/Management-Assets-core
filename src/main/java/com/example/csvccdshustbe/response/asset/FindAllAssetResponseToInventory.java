...
public class FindAllAssetResponseToInventory {
    ...
    @JsonProperty("quantity_inventory")
    private Integer quantityInventory;
    @JsonProperty("total_original_of_formation_inventory")
    private String totalOriginalOfFormationInventory;
    @JsonProperty("rest_value_inventory")
    private String restValueInventory;
