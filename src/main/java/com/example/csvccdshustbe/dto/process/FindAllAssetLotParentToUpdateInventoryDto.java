...
@Getter
@Setter
public class FindAllAssetLotParentToUpdateInventoryDto {
    ...
    @Getter
    private List<FindAllAssetLotChildrenToUpdateInventoryDto> assetLeaves = new ArrayList<>();

    public FindAllAssetLotParentToUpdateInventoryDto(Object[] obj){
        ...
        this.isLeaf = ValueUtil.getIntegerByObject(obj[7]);
