...
@Getter
@Setter
public class FindAllAssetParentToUpdateInventoryDto {
    ...
    @Getter
    private List<FindAllAssetChildrenToUpdateInventoryDto> assetLeaves = new ArrayList<>();

    public FindAllAssetParentToUpdateInventoryDto(Object[] obj){
