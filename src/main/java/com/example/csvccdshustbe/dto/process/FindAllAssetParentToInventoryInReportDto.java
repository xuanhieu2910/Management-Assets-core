...
@Getter
@Setter
public class FindAllAssetParentToInventoryInReportDto {
    ...
    @Getter
    private List<FindAllAssetChildrenToInventoryInReportDto> assetLeaves = new ArrayList<>();

    public FindAllAssetParentToInventoryInReportDto(Object[] obj){
