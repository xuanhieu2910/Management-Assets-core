...
public class AssetDepreciationRepositoryImpl implements AssetDepreciationRepositoryCustom {
    ...
    @Override
    public Optional<AssetDepreciation> findAssetDepreciationByIdAsset(Integer idAsset) {
        StringBuilder sb = new StringBuilder();
        sb.append(" select ad.id_asset_depreciation, ad.id_asset,  " +
                "       ad.time_started_depreciation, ad.amount_months_depreciation,  " +
                "       ad.value_depreciation, ad.type_depreciation,   " +
                "       ad.value_type_depreciation, ad.amount_rest_months_depreciation,   " +
                "       ad.cumulative, ad.rest_value, ad.time_started_wear_tear,  " +
                "       ad.time_end_wear_tear, ad.type_calculate, ad.time_buy,   " +
                "       ad.time_started_used, ad.time_started_increase,   " +
                "       ad.time_year_tracking, ad.time_created, ad.time_modified  " +
                "from asset_depreciation ad   " +
                "    inner join asset asset on ad.id_asset = asset.id_asset  " +
