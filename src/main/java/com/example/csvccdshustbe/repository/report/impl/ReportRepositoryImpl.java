...
//        return responses;
    ...
    @Override
    public BlueprintInventoryReportDto findBlueprintInventoryReportDtoByCodeDocument(FindAllAssetProcessRequest request){
        StringBuilder sb = new StringBuilder();
    ...
    @Override
    public List<FindAllToolProcessDto> findInfoToolForInventoryReportByCodeDocument(FindAllToolProcessRequest request) {
        StringBuilder sb = new StringBuilder();
